      ...
      <div class="row">
        <section class="col-lg-12">
          <div class="card card-primary card-outline">
            ...
            ?>
            <form action="<?= admin_url('slider/create') ?>" method="post">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Link:</label>
                      <input type="text" class="form-control" name="link" placeholder="Link khi click vào banner.">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="thumb" placeholder="Link ảnh...">
                    </div>
                  </div>
