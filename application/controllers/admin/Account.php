...
class Account extends MY_Controller
{
  ...
  function index()
  {
    ...
    $sellerS = $this->input->get('seller_id');
  ...
  function update()
  {
    ...
    if (!$account_info) {
      return redirect(admin_url('account/index'));
    }
  ...
  function create()
  {
    if ($this->input->post()) {
      ...
      if ($this->form_validation->run()) {
        ...
        redirect(admin_url('account/create'));
      }
    }

    $this->data['title'] = 'Thêm tài khoản';
    $this->data['temp'] = 'admin/account/create';
    $this->load->view('admin/main', $this->data);
  }
}
